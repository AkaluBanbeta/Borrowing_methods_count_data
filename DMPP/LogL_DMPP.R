...
########### Log-likelihood function for DMPP
LikelihoodMPP_DMPP <- function(parameters,H,X0,X,Y0,Y,weightTemp,ScalingConstantTemp){
  dim=ncol(X0[[1]])
  ...
  LikelihoodMPP_DMPP<- Prior0+lik.01+lik.02+lik-ScalingConstantTemp
}
